...
import com.example.recipica.Models.Recipe;
...
public class recipeAdapter extends RecyclerView.Adapter<recipeAdapterViewHolder> {
    ...
    public recipeAdapterViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new recipeAdapterViewHolder(LayoutInflater.from(context).inflate(R.layout.list_random_recipe, parent, false ));
    }
